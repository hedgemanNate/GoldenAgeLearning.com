        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;">
          ...
          <tr>
            <td style="padding-bottom:32px;text-align:center;border-bottom:2px solid ${TEXT};">
              ...
              <img src="https://goldenagelearning.com/assests/GoldenAgeLearningLogo2-resized.png"
                   alt="Golden Age Learning"
                   width="80" height="80"
                   style="display:block;margin:12px auto 0;border:0;" />
            </td>
          </tr>
...
export function bookingConfirmationTemplate(v: BookingConfirmationVars): string {
  const body = `
...
export function classReminderTemplate(v: ClassReminderVars): string {
  const body = `
    ...
    ${para("If anything has come up and you cannot make it, please give us a call as soon as possible so we can reschedule you. That way you do not lose your spot.")}
...
export function transferConfirmationTemplate(v: TransferConfirmationVars): string {
  const body = `
    ${heading("Class Transfer Complete!")}
    ${para(`Dear ${v.customerName},`)}
    ${para("Your class booking has been rescheduled. Here are the details for your new class:")}
    ${detailBox(
      detailRow("Class", v.className) +
      detailRow("Date", v.classDate) +
      detailRow("Time", v.classTime) +
...
export function paymentReceivedTemplate(v: PaymentReceivedVars): string {
  const body = `
...
export function paymentDeclinedTemplate(v: PaymentDeclinedVars): string {
  const body = `
...
export function passwordResetTemplate(v: PasswordResetVars): string {
  const body = `
...
export function welcomeTemplate(v: WelcomeVars): string {
  const body = `
    ${heading("Welcome to Your Golden Age of Learning!")}
    ${para(`Dear ${v.customerName},`)}
    ${para("We are so glad you are here. Golden Age Learning was created just for you! It's a place to learn new things, connect with others, and enjoy yourself.")}
    ${para("Browse our upcoming classes and reserve your spot for any class that interests you If you ever need help, just give us a call. We are happy to walk you through everything step by step.")}
