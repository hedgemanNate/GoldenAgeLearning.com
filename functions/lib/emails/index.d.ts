 ...
 */
import { type BookingConfirmationVars, type ClassReminderVars, type TransferConfirmationVars, type PaymentReceivedVars, type PaymentDeclinedVars, type PasswordResetVars, type WelcomeVars } from "./templates";
