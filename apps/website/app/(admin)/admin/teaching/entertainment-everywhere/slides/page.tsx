...
import { entertainmentEverywhereSlides } from "../_slides/content";

const CLASS_SLUG = "entertainment-everywhere";
const TOTAL_SLIDES = entertainmentEverywhereSlides.length;
const titleSlide = entertainmentEverywhereSlides[0];

export default function EntertainmentEverywhereSlidesLaunch() {
  const {
    session,
    loading,
    isActive,
