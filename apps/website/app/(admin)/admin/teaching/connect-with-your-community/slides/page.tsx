...
import { connectWithYourCommunitySlides } from "../_slides/content";

const CLASS_SLUG = "connect-with-your-community";
const TOTAL_SLIDES = connectWithYourCommunitySlides.length;
const titleSlide = connectWithYourCommunitySlides[0];

export default function ConnectWithYourCommunitySlidesLaunch() {
  const {
    session,
    loading,
    isActive,
