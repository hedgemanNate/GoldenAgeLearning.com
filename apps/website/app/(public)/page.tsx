  ...
  return (
    <main className="w-full">
      ...
      <section className="w-full bg-[var(--color-dark-bg)] px-[24px] py-[80px] flex flex-col items-center text-center">
        ...
        <Link
          href="/classes"
          className="bg-[var(--color-slate)] text-[var(--color-cream)] font-sans text-[18px] h-[60px] w-full max-w-[400px] px-[32px] rounded-[12px] hover:bg-opacity-90 transition-opacity flex items-center justify-center mb-[56px]"
        >
          Pick A Class
        </Link>
